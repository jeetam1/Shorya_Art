    ...
    <div className="awards-page-container">
      ...
      <div className="awards-content-wrapper">
        ...
        <section className="award-section">
          ...
          <img loading="lazy" src="/events-photos/35.jpg" alt="Microsoft Future Decoded" className="award-image" />
        ...
        <section className="award-section">
          ...
          <img loading="lazy" src="/events-photos/36.jpg" alt="Celebrity Chef Gala Certificate" className="award-image" />
          <p className="award-text">
        ...
        <section className="award-section">
          ...
          <img loading="lazy" src="/events-photos/37.jpg" alt="Pogo Amazing Kids Awards 2012" className="award-image" />
          <p className="award-text">
        ...
        <section className="award-section">
          ...
          <img loading="lazy" src="/events-photos/38.jpg" alt="TEDx Appreciation" className="award-image" />
          <p className="award-text">
        ...
        <section className="award-section">
          ...
          <img loading="lazy" src="/events-photos/39.png" alt="With R.K. Laxman" className="award-image" />
          <p className="award-text">
