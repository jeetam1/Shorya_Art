    ...
    <div className="rd-page-container">
      <div className="rd-content-wrapper">
        ...
        <div className="rd-text-image-block">
          ...
          <img loading="lazy" src="/media/ab1.jpg" alt="Reader's Digest Logo" className="rd-inline-image-right" />
        ...
        <div className="rd-text-image-block">
          ...
          <img loading="lazy" src="/media/ab2.jpg" alt="Shorya Painting" className="rd-inline-image-center" />
        </div>
        ...
        <div className="rd-text-image-block">
          ...
          <img loading="lazy" src="/media/ab3.jpg" alt="Abstract Art Feature" className="rd-inline-image-center" />
        </div>
